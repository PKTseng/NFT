<template>
  ...
  <button
    v-if="!connected"
    @click="connectWallet"
    class="bg-gradient-to-r from-pink-500 to-yellow-500 text-white text-xl font-bold px-8 py-4 rounded-2xl shadow-lg hover:scale-110 hover:rotate-1 transition-all duration-300"
  >
    Connect Wallet
  </button>
